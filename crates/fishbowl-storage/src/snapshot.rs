...
const FORMAT: &str = "fishbowl";
const LEGACY_FORMAT: &str = "engineering-knowledge-graph";
const VERSION: u32 = 1;
...
fn validate_archive(a: &ProjectGraphSnapshot) -> Result<(), WriteError> {
    if (a.format != FORMAT && a.format != LEGACY_FORMAT) || a.version != VERSION {
...
mod compatibility_tests {
    ...
    #[test]
    fn accepts_pre_rename_snapshot_format() {
        let archive = ProjectGraphSnapshot {
            format: LEGACY_FORMAT.into(),
            version: VERSION,
            exported_at: "2026-07-17T00:00:00.000Z".into(),
            project: SnapshotProject {
                id: Uuid::new_v4().to_string(),
                name: "Legacy".into(),
                description: None,
                created_at: "2026-07-17T00:00:00.000Z".into(),
            },
            cases: vec![],
            nodes: vec![],
            edges: vec![],
